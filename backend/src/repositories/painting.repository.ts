...
export interface PaintingRepository {
  ...
  createPainting(painting: Prisma.PaintingCreateInput): Promise<Prisma.PaintingCreateManyInput>
  updatePainting(id: string, painting: Prisma.PaintingCreateInput): Promise<Prisma.PaintingCreateManyInput | null>
